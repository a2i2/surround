...
class InitTest(unittest.TestCase):
    def setUp(self):
        subprocess.run(
            [
                ...
                "Stefanus Kurniawan",
                "-e",
                "stefanus.kurniawan@deakin.edu.au",
                "-w",
                "False",
            ],
            encoding="utf-8",
    ...
    def test_run_from_subdir(self):
        process = subprocess.run(
            ["surround", "run"], encoding="utf-8", stdout=subprocess.PIPE, check=True
        )
    ...
    def test_remote_from_subdir(self):
        ...
        process = subprocess.run(
            ["surround", "store", "remote", "-a", "-n", "test_remote", "-u", "~"],
            encoding="utf-8",
            stdout=subprocess.PIPE,
            cwd="temp/temp",
            check=True,
    ...
    def test_pull_from_subdir(self):
        process = subprocess.run(
            ["surround", "store", "pull", "test_remote", "-k", "a.jpg"],
            encoding="utf-8",
            stdout=subprocess.PIPE,
            check=True,
        )
        ...
        process = subprocess.run(
            ["surround", "store", "remote", "-a", "-n", "test_remote", "-u", "remote"],
            encoding="utf-8",
            stdout=subprocess.PIPE,
            cwd="temp/temp",
            check=True,
        ...
        process = subprocess.run(
            ["surround", "store", "pull", "test_remote", "-k", "a.txt"],
            encoding="utf-8",
            stdout=subprocess.PIPE,
            cwd="temp/temp",
            check=True,
        ...
        self.assertRegex(
            process.stdout, r"info: test_remote[/\\]{1,2}a.txt already exists\n"
        )

    def test_push_from_subdir(self):
        process = subprocess.run(
            ["surround", "store", "push", "test_remote", "-k", "a.jpg"],
            encoding="utf-8",
            stdout=subprocess.PIPE,
            check=True,
        )
        ...
        process = subprocess.run(
            ["surround", "store", "push", "test_remote", "-k", "a.txt"],
            encoding="utf-8",
            stdout=subprocess.PIPE,
            cwd="temp",
            check=True,
        ...
        self.assertRegex(
            process.stdout,
            r"info: remote[/\\]{1,2}temp[/\\]{1,2}a.txt already exists\n",
        )

        process = subprocess.run(
            ["rm", "test_remote/a.txt"],
            encoding="utf-8",
            stdout=subprocess.PIPE,
            cwd="temp",
            check=True,
    ...
    def test_list_from_subdir(self):
        process = subprocess.run(
            ["surround", "store", "list", "test_remote"],
            encoding="utf-8",
            stdout=subprocess.PIPE,
            check=True,
        )
