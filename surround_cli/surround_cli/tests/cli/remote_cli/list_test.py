...
class ListTest(unittest.TestCase):
    ...
    def test_rejecting_path(self):
        ...
        process = subprocess.run(['surround', 'store', 'list', 'temp'], encoding='utf-8', stdout=subprocess.PIPE, cwd='temp', check=True)
    ...
    def test_happy_path(self):
        ...
        process = subprocess.run(['surround', 'store', 'remote', '-a', '-n', 'temp_remote', '-u', os.getcwd() + '/temp'], encoding='utf-8', stdout=subprocess.PIPE, cwd='temp', check=True)
        ...
        process = subprocess.run(['surround', 'store', 'list', 'temp_remote'], encoding='utf-8', stdout=subprocess.PIPE, cwd='temp', check=True)
