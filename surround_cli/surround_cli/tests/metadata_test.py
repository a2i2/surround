...
class TestMetadata(unittest.TestCase):
    ...
    def test_nested_get_property(self):
        ...
        metadata.set_property(
            "summary", {"title": "test_title", "description": "test_description"}
        )

        self.assertEqual(
            metadata.get_property("summary.title"), metadata["summary"]["title"]
        )
        self.assertEqual(
            metadata.get_property("summary.description"),
            metadata["summary"]["description"],
        )
        self.assertEqual(metadata.get_property("summary.title"), "test_title")
        self.assertEqual(
            metadata.get_property("summary.description"), "test_description"
        )
